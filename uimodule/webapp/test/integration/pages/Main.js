sap.ui.require([
  ...
  var sViewName = "com.rikosjett.localVSCodeDemo.view.MainView";
      ...
      assertions: {
          ...
          iShouldSeeTheTitle: function () {
            return this.waitFor({
              ...
              properties: {
                text: "com.rikosjett.localVSCodeDemo"
              },
              success: function() {
                Opa5.assert.ok(true, "The page shows the correct title");
              },
              errorMessage: "App does not show the expected title com.rikosjett.localVSCodeDemo"
            });
        }
      }
